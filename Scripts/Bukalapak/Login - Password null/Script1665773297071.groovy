...
WebUI.setText(findTestObject('Object Repository/Bukalapak repo/Page_LoginBukalapak/input_Password'), '')

WebUI.click(findTestObject('Object Repository/Bukalapak repo/Page_LoginBukalapak/button_Login'))

WebUI.verifyElementText(findTestObject('Bukalapak repo/Alert_LoginBukalapak/p_Password wajib diisi, ya'), 'Password wajib diisi, ya.')
