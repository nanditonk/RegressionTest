...
WebUI.setText(findTestObject('Object Repository/Bukalapak repo/Page_LoginBukalapak/input_Password'), '123')

WebUI.click(findTestObject('Object Repository/Bukalapak repo/Page_LoginBukalapak/button_Login'))

WebUI.verifyElementText(findTestObject('Bukalapak repo/Alert_LoginBukalapak/p_Password yang kamu masukkan salah. Silakan coba lagi'), 
